...
<c:if test="${fn:length(cart.cartItems) == 0 }">
	<h1>亲!你还没有购物,请去<a href="${pageContext.request.contextPath }/bookServlet?method=findAll">购物</a></h1>
	<img src="${pageContext.request.contextPath }/images/cart.png" width="150" height="170"/>
</c:if>
<c:if test="${fn:length(cart.cartItems) != 0 }">
